...
// FROM 24/07/2016
// FOR THE FINAL FIT OF THE TRASNVERSE MASS BLINDED IN HP
//
...
// root[] .x fitResultMTHP.C("HP")

#include "TMath.h"
#include "string.h"

void fitResultMTHP(std::string key)
{
...
//---------------------------------------------------------------------------------------------
 ...
 // --------------------------------------------------------------------------
  ...
  TText* tex3 = new TText(1600,1150,"2.318 /fb (13TeV)") ;
