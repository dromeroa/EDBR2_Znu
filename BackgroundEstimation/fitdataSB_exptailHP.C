...
void fitdataSB_exptailHP(std::string key)
{
...
//********************************************************************************//
 ...
 RooFormulaVar coef( "coef","@0/@1", RooArgList(Sub_SB_yield,Dom_SB_yield));
  ...
  RooRealVar s1("s1","slope of the exp1", 200., 0., 1000.);
  RooRealVar a1("a1","parameter of exp1", 0. , -1, 1);
...
//---------------------------------------------------------------------------------------------
 ...
 // --------------------------------------------------------------------------
  ...
  Data_SB_pdf.plotOn( plot2,Name("error2"),VisualizeError(*testf1,1),LineColor(kBlack),FillColor(kAzure-2),FillStyle(3002));
  ...
  TText* txt1a = new TText(700,200,"Preliminary") ;
