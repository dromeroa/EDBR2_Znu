...
void testQCDfit(std::string key)
{
...
//  frame3->getAttText()->SetTextSize(0.020);
  ...
  leg1b->AddEntry("mc3",  "QCD Background ",    "ep");
  ...
  t3->Draw();
  // SAVE THE FILE
  cv3.SaveAs(Form("otherPlots/QCDMj%s_gaus2.png",key.c_str()));
  cv3.SaveAs(Form("otherPlots/QCDMj%s_gaus2.pdf",key.c_str()));
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
