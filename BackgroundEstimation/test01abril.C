...
/*
      ...
      treeMC2.Add(      "../trees/newtrees/treeEDBR_QCD_HT300to500_76x_v2.root"                  );
      treeMC2.Add(      "../trees/newtrees/treeEDBR_QCD_HT700to1000_25ns_v2.root"                 );
      treeMC2.Add(      "../trees/newtrees/treeEDBR_TTbar_25ns_v2.root"                           );
      treeMC2.Add(      "../trees/newtrees/treeEDBR_VV_25ns_v2.root"                              );
      treeMC2.Add(      "../trees/newtrees/treeEDBR_WW_25ns_v2.root"                              );
      treeMC2.Add(      "../trees/newtrees/treeEDBR_ZZ_25ns_v2.root"                              );
      treeMC1.Add(      "../trees/newtrees/treeEDBR_W+Jets_25ns_v2.root"                          );
      treeMC1.Add(      "../trees/newtrees/treeEDBR_WJetsToLNu_HT-100To200_25ns_v2.root"          );
      treeMC1.Add(      "../trees/newtrees/treeEDBR_WJetsToLNu_HT-200To400_25ns_v2.root"          );
      treeMC1.Add(      "../trees/newtrees/treeEDBR_WJetsToLNu_HT-400To600_25ns_v2.root"          );
      treeMC1.Add(      "../trees/newtrees/treeEDBR_Z+Jets_25ns_v2.root"                          );
      treeMC1.Add(      "../trees/newtrees/treeEDBR_ZJetsToNuNu_HT-100To200_25ns_v2.root"         );
      treeMC1.Add(      "../trees/newtrees/treeEDBR_ZJetsToNuNu_HT-200To400_25ns_v2.root"         );
      treeMC1.Add(      "../trees/newtrees/treeEDBR_ZJetsToNuNu_HT-400To600_25ns_v2.root"         );
...
//  RooFitResult *rf4a = emodel4a.fitTo(bkg2, Save(1), PrintLevel(plevelnorm));
  ...
  TText* te1 = new TText(45,53,"CMS") ;
  te1->SetTextSize(0.04) ;
  te1->SetTextColor(kBlack) ;
  te1->SetTextFont(61);
  frame1->addObject(te1) ;

  TText* txt1a = new TText(45,50,"Simulation") ;
  ...
  TText* txt2a = new TText(160,58,"2.307 /fb (13TeV)") ;
...
//  model2a.plotOn(frame2,Name("error2"),VisualizeError(*rf2a,1),FillColor(kAzure-2), FillStyle(3002),Range(40,160));
  ...
  TText* tx1 = new TText(50,33,"CMS") ;
  tx1->SetTextSize(0.04) ;
  tx1->SetTextColor(kBlack) ;
  tx1->SetTextFont(61);
  frame2->addObject(tx1) ;

  TText* tx2 = new TText(50,31,"Simulation") ;
  ...
  TText* tx3 = new TText(161,38,"2.307 /fb (13TeV)") ;
...
//  model3a.plotOn(frame3,Name("error3"),VisualizeError(*rf3a,1),FillColor(kAzure-2), FillStyle(3002));
  ...
  TText* tx7 = new TText(50,33,"CMS") ;
  tx7->SetTextSize(0.04) ;
  tx7->SetTextColor(kBlack) ;
  tx7->SetTextFont(61);
  frame4->addObject(tx7) ;

  TText* tx8 = new TText(50,31,"Simulation") ;
  ...
  TText* tx9 = new TText(159,39,"2.307 /fb (13TeV)") ;
...
// upsigObs.plotOn(frame5,Binning(36),Name("dataupsig"),MarkerColor(kRed));
 ...
 frame5->SetTitle("");
  ...
  TText* txt2 = new TText(159,112,"2.307 /fb (13TeV)") ;
