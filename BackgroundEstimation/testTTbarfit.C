...
void testTTbarfit(std::string key)
{
...
//  frame3->getAttText()->SetTextSize(0.020);
  ...
  leg1b->AddEntry("mc3",  "TTbar Background ",    "ep");
  ...
  t3->Draw();
  // SAVE THE FILE
  cv3.SaveAs(Form("otherPlots/TTbarMj%s_gaus2.png",key.c_str()));
  cv3.SaveAs(Form("otherPlots/TTbarMj%s_gaus2.pdf",key.c_str()));
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
