...
void testyieldsLP(std::string key)
{
...
//********************************************************************************//
  ...
  RooRealVar totalWeight("totalWeight", "total weight",  -10.,  10.         );
...
/////////////////////////////////////////////////////////////////////////////////////
  ...
  RooRealVar mu1("mu1", "average", 196 , 0., 500);
  RooRealVar sigma1("sigma1", "sigma", 44, 0, 200);
  RooRealVar mu2("mu2", "average", 73, 0., 200);
  RooRealVar sigma2("sigma2", "sigma",23, 0., 100); 
  ...
  RooAddPdf model2("Gaus+gaus", "gaussian plus gauss", RooArgList(gauss1, gauss2), funfrac);
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
