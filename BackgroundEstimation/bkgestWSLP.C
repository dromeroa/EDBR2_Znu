...
void bkgestWSLP(std::string key)
{
...
RooRealVar width1("width1",  "width of the erf",     36.0,   1,   100.);
  ...
  RooRealVar mu1("mu1", "average", 79.6, 0, 300);
  RooRealVar sigma1("sigma1", "sigma", 100, 0, 300);
...
RooRealVar a4("a4","parameter of exp4", 1., 0., 10);
...
w->writeToFile(Form("workSpaces/Workspace2/CMS_ZZnunu_%s_13TeV.root",key.c_str()));
