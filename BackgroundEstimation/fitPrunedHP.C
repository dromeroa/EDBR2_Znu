...
// FROM 24/07/2016
// FIT FOR DOMINANT AND SUBDOMINANT MC IN THE PRUNED MASS HP
//
...
// root[] .x fitPrunedHP.C("HP")

#include "TMath.h"
#include "string.h"

void fitPrunedHP(std::string key)
{
...
/////////////////////////////////////////////////////////////////////////////////////
  ...
  TText* txt2a = new TText(160,59,"2.318 /fb (13TeV)") ;
  ...
  TText* tx3 = new TText(161,39,"2.318 /fb (13TeV)") ;
...
//  frame2->GetYaxis()->SetRangeUser(0,50);
  ...
  TText* tx6 = new TText(159,42,"2.318 /fb (13TeV)") ;
 ...
 frame5->SetTitle("");
  ...
  TText* txt2 = new TText(159,113,"2.318 /fb (13TeV)") ;
