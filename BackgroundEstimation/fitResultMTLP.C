...
///////////////////////////////////////////////////////////////////////////////////////
 ...
 // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  RooFitResult *rf2 = emodel2_pdf.fitTo(bkg2, Save(1), PrintLevel(plevelnorm2),Range(40,160));
...
// RooRealVar s4("s4","slope of the exp4", 1., 0., 200.);
...
//  RooRealVar a4("a4","parameter of exp4", 0.03 , 0., 60.);
...
//  alpha_pdf.paramOn(plot3,Layout(0.50,0.99,0.9)) ;
  ...
  TText* te1 = new TText(800,56000,"CMS") ;
  te1->SetTextSize(0.03) ;
  te1->SetTextColor(kBlack) ;
  te1->SetTextFont(61);
  plot3->addObject(te1) ;

  TText* txt1a = new TText(800,54000,"Simulation") ;
  ...
  TText* txt2a = new TText(2500,61000,"2.307 /fb (13TeV)") ;
...
//  plot5->getAttText()->SetTextSize(0.03);
  ...
  TText* tex3 = new TText(2500,1100,"2.307 /fb (13TeV)") ;
