...
process.treeDumper = cms.EDAnalyzer(            "EDBRTreeMaker",
                                                ...
                                                correctEW           = cms.bool      (  True                       ),
                                                correctBtag         = cms.bool      (  True                       ),    
                                                originalNEvents     = cms.int32     (  usedNevents                ),
                                                crossSectionPb      = cms.double    (  usedXsec                   ),
                                                targetLumiInvPb     = cms.double    (  2318                       ),
                                                ...
                                                EWcorr = cms.FileInPath("ExoDiBosonResonances/EDBRTreeMaker/data/inputfiles/ElectroweakCorrections.root"),
                                                ...
                                                btaggEff = cms.FileInPath("ExoDiBosonResonances/EDBRTreeMaker/data/inputfiles/btaggMaps/ZJetsToNuNu_HT-400To600_MAP.root"),
