...
###
### new global tag with correction
...
configXsecs = {   "MET_Run2015C"      : 1.0,
              }

configNevents = { "MET_Run2015C"       :1,
                }
...
###   THERE IS NO PHOTON ID FOR 25 ns (solo MVA)  
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("treeEDBR_"+SAMPLE+"now.root")
                                  )
