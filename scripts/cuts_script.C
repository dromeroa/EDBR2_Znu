...
********************************************************************************************************************
 ...
 root -l cuts_script.C+

obviar esto:
 or if is not in the same folder root 'analysisTTree.C("/mnt/aheplabpce/vj/Linux/BXsPhi/jae/rootfiles/file1.root")'
...
cout << "************************************************************************************"<<endl;
     ...
     for (unsigned int i=0; i<Ncuts; i++){
           ...
           cout << "the punzi significance 1  is    "  << S_eff2[i] / (1 + sqrtB[i])   <<  "  "  <<  cuts[i] <<endl;
     }
